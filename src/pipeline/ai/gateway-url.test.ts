...
const GATEWAY = "http://digest-pipeline-gateway.tenants-digest-pipeline.svc.cluster.local:8080";
...
describe("anthropicBaseUrl", () => {
  ...
  it("does not return the bare gateway root", () => {
    ...
    // the body, no route rule matches, and every generation fails while the
